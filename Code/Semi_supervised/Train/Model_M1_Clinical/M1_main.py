...
from Code.Semi_supervised.Train.Model_M1_Clinical.dataloader import CustomDataset
from Code.Semi_supervised.Train.Model_M1_Clinical.M1_train import train
...
class Pipeline:
    ...
    def trainModel_M0(self):
        obj = M0_Pipeline(self.train_type, epochs=500)
        obj.trainModel()
